		...
		<!-- Formulario -->
  		<div class="container_form">
			...
			<form class="formulario" action="" method="POST">		
						...
						<input type="text" name="direccion" maxlength="20" id="direccion">
						<label for="cuit">Cuit</label>
						<input type="text" name="cuit" maxlength="20" id="cuit">
						...
						<input type="text" name="usuario" maxlength="20" id="usuario">
						<label for="contrasenia">Contraseña</label>
						<input type="password" name="contrasenia" maxlength="20" id="contrasenia">
