	...
	<!-- Barra de navegación principal -->
		...
		<div class="row">
  		...
  		<div class="col-12 col-lg-10 "> <!-- zona forms y tablas -->
			<div class="titulo-formulario p-2 mt-2 text-center"><h4>NUEVA SALA</h4></div>
			<form class="formulario" action="" method="POST">
				<div class="bloque_form_columns mt-2">		
					<div class="form_column1">	
						...
						<label for="cant_asientos">Cantidad de butacas totales</label>
						<input class="input_general" type="number" name="cant_asientos" min="1" max="100" step="1" id="cant_asientos" required>
